...
byte lepton_image[LEPTON_IMAGE_SIZE+1078] = {0x42,0x4d,
0xf6,0x16,0x00,0x00,
0x00,0x00,0x00,0x00,
0x36,0x04,0x00,0x00,
0x28,0x00,0x00,0x00,
...
bool read_lepton_frame()
{
  ...
  while (millis() - start_time < 100)
  {
    ...
    if (valid_line)
    {
      ...
      {
        lepton_image[LEPTON_IMAGE_SIZE-(line_id * LEPTON_WIDTH+i+1) + 1078] = line_buffer[5+(LEPTON_WIDTH-i-1)*2];//fill reversed
      }
    }
    if (line_id == 59)
    {
