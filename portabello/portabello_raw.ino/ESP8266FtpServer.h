...
#define FTP_CMD_SIZE 100 // max size of a command
#define FTP_CWD_SIZE 100 // max size of a directory name
#define FTP_FIL_SIZE 100     // max size of a file name
#define FTP_BUF_SIZE 4800 //512   // size of file buffer for read/write

class FtpServer
{
public:
  void    begin(String uname, String pword, void (* _connection_cb)(), void (* _disconnect_cb)(), byte * _buf);
  void    handleFTP();
...
private:
  ...
  uint16_t dataPort;
  byte     * buf;       // data buffer for transfers
