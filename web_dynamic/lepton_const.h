...
byte scol=0,srow=0,ecol=0,erow=0;
unsigned long th = 10000;
...
void paintROI()
{
  ...
  {
    lepton_image[(59-srow)*80+i] = 0;
    lepton_image[(59-erow)*80+i] = 0;
  }
  
  for(int i = srow; i< erow; i++) // paint vertical 
  {
    lepton_image[scol+(59-i)*80] = 0;
    lepton_image[ecol+(59-i)*80] = 0;
  }
}

const byte lepton_img_header[] = {0x42,0x4d,
0xf6,0x16,0x00,0x00,
0x00,0x00,0x00,0x00,
0x36,0x04,0x00,0x00,
0x28,0x00,0x00,0x00,
