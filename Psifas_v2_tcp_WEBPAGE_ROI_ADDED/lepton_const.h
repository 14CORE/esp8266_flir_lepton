...
void lepton_set_roi (byte StartCol, byte StartRow, byte EndCol, byte EndRow);
...
{                                                                             // min/max end values: (column; >StartCol+1 / 78, row; >StartRow+1 / 58) 
  ...
  */
  ...
  data_write[2] = (StartCol);
  data_write[3] = (StartRow);
